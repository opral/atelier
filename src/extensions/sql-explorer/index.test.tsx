...
describe("isReadOnlyStatement", () => {
	test.each([
		...
		['SELECT commit_id FROM public."lix_apply"($1,$2)', false],
		["SELECT commit_id FROM lix_undo($1)", false],
		["SELECT commit_id FROM lix_redo($1)", false],
		["SELECT 'lix_revert($1)' AS example", true],
