 ...
 *
 * Known limitation: when the write put content inside the stretch one of
 * the writer's steps covers (a block between the two halves of a split, text
 * inside a word being typed), undoing that step deletes the mapped stretch,
 * and the outside content in it goes too.
 */
