	...
	const handleOpenDiff = useCallback(
		(file: CommitFile) => {
			...
			context.openWidget({
				...
				instance: diffWidgetInstance(file.id),
				state: buildDiffWidgetProps({
					fileId: file.id,
 ...
 *
 * @example
 * import { widget as commitView } from "@/widgets/commit-view";
 */
